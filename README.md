...
### The screenshots below are no longer up to date - Assault Mode and the Samoa map have since been added. The minimum amount of modes to choose is now 4 rather than 3, and the map category picks of the captains are no longer shown, so the second captain can't rig it by choosing one of the first captain's picks, and all of the modes they didn't pick.
